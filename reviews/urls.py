...
urlpatterns = [
    ...
    path('user_reviews/', views.UserReviews.as_view(), name='user_reviews'),
    path('reviews/<int:pk>/', views.ReviewSingle.as_view(), name='review'),
    path('reviews/edit/<int:pk>/', views.UpdateReview.as_view(), name='update_review'),
    path('reviews/<int:pk>/remove', views.DeleteReview.as_view(), name='delete_review'),
