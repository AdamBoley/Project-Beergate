...
urlpatterns = [
    ...
    path('index_most_upvotes/', views.ReviewListMostUpvotes.as_view(), name='most_upvotes'),
    path('index_oldest/', views.ReviewListOldest.as_view(), name='oldest'),
    path('user_review/', views.AddReviewView.as_view(), name='add_review'),
